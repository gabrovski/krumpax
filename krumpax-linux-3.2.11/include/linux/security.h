...
#endif /* CONFIG_AUDIT */
  void (*krum_test_hook) (void);
  int (*krum_do_pfault_check_address) (struct pt_regs *regs, unsigned long error_code, unsigned long *address);
  void (*krum_do_mmap_pgoff) (struct mm_struct *mm, vm_flags_t *vm_flags, struct file *file);
};

void security_krum_test_hook(void);
